...
export function DitheringShader({
  ...
  useEffect(() => {
    const updateDimensions = () => {
      if (containerRef.current) {
        ...
        // For fixed positioned elements, use window dimensions if rect is invalid
    ...
    updateDimensions()
    // Use requestAnimationFrame to ensure dimensions are set after mount
  ...
  }, [dimensions.width, dimensions.height, width, height, colorBack, colorFront, shape, type, pxSize, speed])
